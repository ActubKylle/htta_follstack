...
export default function StudentScholarshipIndex({ scholarships = [] }: StudentScholarshipsIndexProps) {
    // Format date helper
                                    ...
                                    <CardHeader>
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                <CardTitle className="text-xl font-semibold text-htta-blue mb-2">
                                    ...
                                    <CardContent className="flex-1 flex flex-col">
                                        ...
                                        <div className="mt-auto">
                                            {scholarship.status === 'Open' ? (
                                                <Link
                                                    href={route('student.scholarships.apply', scholarship.scholarship_id)}
                                                    className="w-full"
                                                >
                                                ...
                                                <Button disabled className="w-full">
                                                    {scholarship.status === 'Closed' ? 'Applications Closed' : 'Not Available'}
                                                </Button>
                                            )}
                                        </div>
                                    </CardContent>
